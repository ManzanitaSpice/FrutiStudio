...
Este documento resume qué necesita un launcher para que una instancia de Minecraft sea **ejecutable de extremo a extremo** y cómo queda cubierto en FrutiStudio.
...
## Estado en FrutiStudio (implementado)
...
FrutiStudio ya pasa `username/uuid/accessToken/userType` al plan de lanzamiento; el siguiente paso de producto es endurecer el flujo MSA para que siempre haya sesión válida cuando se quiera jugar online.
